				...
				<div className="card-section p-4 space-y-5">
					...
					{user ? (
						...
						<div className="space-y-3">
							...
							<button onClick={() => signIn()} className="w-full text-sm flex items-center justify-center gap-2 px-4 py-1 rounded-xl font-bold transition-all active:scale-95 border border-primary-500/50 bg-emerald-500/5 text-stone-900 dark:border-primary-500/40 dark:bg-emerald-900/20 dark:text-white hover:bg-emerald-500/10 dark:hover:bg-emerald-900/30 shadow-sm">
